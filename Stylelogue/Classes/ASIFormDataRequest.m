...
#if NSLog_FORM_DATA_REQUEST
- (void)addToNSLogBody:(NSString *)string;
@property (retain, nonatomic) NSString *NSLogBodyString;
#endif
...
#if NSLog_FORM_DATA_REQUEST
	//NSLog(@"%@",[self NSLogBodyString]);
	[self setNSLogBodyString:nil];
#endif
}
...
#if NSLog_FORM_DATA_REQUEST
	[self addToNSLogBody:@"==== End of multipart/form-data body ====\r\n"];
#endif
}
...
{
	[self addToNSLogBody:[NSString stringWithFormat:@"[%lu bytes of data]",(unsigned long)[data length]]];
...
- (void)appendPostDataFromFile:(NSString *)file
{
	...
	if (err) {
		[self addToNSLogBody:[NSString stringWithFormat:@"[Error: Failed to obtain the size of the file at '%@']",file]];
	} else {
		[self addToNSLogBody:[NSString stringWithFormat:@"[%llu bytes of data from file '%@']",fileSize,file]];
	}
...
- (void)addToNSLogBody:(NSString *)string
{
	[self setNSLogBodyString:[[self NSLogBodyString] stringByAppendingString:string]];
}
#endif
