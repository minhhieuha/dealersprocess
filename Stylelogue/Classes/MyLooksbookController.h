...
#import "TableViewCellBackGroundView.h"
 ...
 @interface MyLooksbookController :  UIViewController<EGORefreshTableHeaderDelegate,UITableViewDataSource, UITableViewDelegate,IconDownloaderDelegate, ParsingFinishDelegate, UIScrollViewDelegate> {
	 ...
	 BOOL _reloading;
	 int currentPage;
	 NSMutableArray *entriesItems;
		 
	 BOOL displayMoreStyles;
 }
 
@property(nonatomic, retain) 	NSMutableArray *entriesItems;
