...
@interface GiveOpinionControllerHot : UIViewController<EGORefreshTableHeaderDelegate,UITableViewDataSource, UITableViewDelegate,IconDownloaderDelegate, ParsingFinishDelegate, UIScrollViewDelegate> {
