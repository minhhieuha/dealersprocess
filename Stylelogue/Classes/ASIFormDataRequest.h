...
@interface ASIFormDataRequest : ASIHTTPRequest <NSCopying> {
	...
	// Will store a string version of the request body that will be printed to the console when ASIHTTPREQUEST_NSLog is set in GCC_PREPROCESSOR_DEFINITIONS
	NSString *NSLogBodyString;
#endif
