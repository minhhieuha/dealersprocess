...
@interface ASIHTTPRequest : NSOperation <NSCopying> {
	...
	// An ID that uniquely identifies this request - primarily used for NSLogging persistent connections
	NSNumber *requestID;
...
// Get the ID of the connection this request used (only really useful in tests and NSLogging)
