...
@interface SignUpController :  UIViewController< UIImagePickerControllerDelegate , UITableViewDataSource, UITableViewDelegate , NewParsingFinishDelegate, UIScrollViewDelegate, UIActionSheetDelegate> {
