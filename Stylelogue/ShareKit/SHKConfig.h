...
#define SHKMyAppName			@"Hello World"
#define SHKMyAppURL				@"www.rubify.com"
...
#define SHKFacebookKey				@"152343918156105"//fb152343918156105
#define SHKFacebookSecret			@"a1ba8ab993f4d6d63e17ca355f000c9b"
//define SHKFacebookKey				@"185060408194598"//fb185060408194598
//define SHKFacebookSecret			@"71efe820e9ecec695c0bfffcafacbf87"
...
//
//Consumer key
//urAa6AxMVZez4EWqzWjoVQ
//Consumer secret
//iFc7TLLeA1fabpNLdZt6qYueLwxwfJNj7vsT5QW2Q7o
//Request token URL
...
//
//#define SHKTwitterConsumerKey		@"8VgbTDKeJX5BLNpoAoF4SA"
//#define SHKTwitterSecret			@"orheC4KykXlwlLQ3mEHDLVh4ZDyrS1NowreYbLJZw"

#define SHKTwitterConsumerKey		@"d6gMgXaRJFW7ayP2Qbs14Q"
#define SHKTwitterSecret			@"NC8hCp6ldbH5riYC2iXRaV9Dzm7BKGLLqZSFw5l2qQ"
#define SHKTwitterCallbackUrl		@"http://stylelouge.projectwebby.com/" // You need to set this if using OAuth, see note above (xAuth users can skip it)
...
#define SHKBarTintColorRed			0 // Value between 0-255, set all to -1 for default
#define SHKBarTintColorGreen		0 // Value between 0-255, set all to -1 for default
#define SHKBarTintColorBlue			0 // Value between 0-255, set all to -1 for default

// Forms
#define SHKFormFontColorRed			0 // Value between 0-255, set all to -1 for default
#define SHKFormFontColorGreen		0 // Value between 0-255, set all to -1 for default
#define SHKFormFontColorBlue		0 // Value between 0-255, set all to -1 for default

#define SHKFormBgColorRed			0 // Value between 0-255, set all to -1 for default
#define SHKFormBgColorGreen			0 // Value between 0-255, set all to -1 for default
#define SHKFormBgColorBlue			0 // Value between 0-255, set all to -1 for default
